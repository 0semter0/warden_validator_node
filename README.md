...
```bash
wget -O $HOME/.warden/config/genesis.json <https://snapshot.nandal.website/warden-testnet/genesis.json>
wget -O $HOME/.warden/config/addrbook.json <https://snapshot.nandal.website/warden-testnet/addrbook.json>
```

## Set Seeds And Peers

```bash
SEEDS="bda08962882048fea4331fcf96ad02789671700e@warden-testnet-peer.nandal.website:35656"
